...
const getStatusUI = (status: EmployeeStatus) => {
  switch (status) {
    ...
    default:
      return { icon: null, iconClass: '', badgeText: '', type: 'info', className: '' }
  }
}
      ...
      >
        <div>
          <div class="flex items-center gap-3 mb-1">
            <el-tag effect="plain" class="!bg-blue-100 !text-blue-700 !border-none !font-bold">
              目标设定阶段
            </el-tag>
          ...
          <div class="overflow-y-auto flex-1 p-2 space-y-1 custom-scrollbar">
            ...
            >
              <el-avatar
                ...
                :class="[selectedEmpId === emp.id ? '!bg-blue-100 !text-blue-700' : '!bg-slate-100 !text-slate-600']"
              >
                <span class="text-xs font-bold">{{ emp.avatar }}</span>
              </el-avatar>
          ...
          <template v-if="selectedEmp">
            ...
            >
              <div class="flex items-center gap-4 min-w-0 w-full sm:w-auto">
                <el-avatar
                  :size="56"
                  class="border-slate-200 shadow-sm shrink-0 !bg-slate-100 !text-slate-600 !text-lg !font-bold"
                >
                  {{ selectedEmp.avatar }}
                </el-avatar>
                <div class="min-w-0">
                  <div class="flex items-center gap-3">
                    ...
                    <el-tag
                      effect="plain"
                      round
                      :class="['!font-bold', getStatusUI(selectedEmp.status as EmployeeStatus).className]"
                    >
              ...
              <div class="flex items-center gap-3 shrink-0">
                <el-button round class="!bg-white !text-slate-700 !font-bold" :disabled="props.isLocked">
                ...
                <el-button
                  type="primary"
                  round
                  class="!font-bold !bg-blue-600 hover:!bg-blue-700 !text-white shadow-sm"
                ...
                >
                  ...
                  >
                    <div class="flex items-center gap-2">
                      ...
                      <el-tag type="info" effect="plain" class="!font-normal !text-[10px] ml-2 !bg-slate-100 !text-slate-500 !border-none">
                        {{ ind.nature }}
                      </el-tag>
                    </div>
...
:deep(.custom-blue-input .el-input__wrapper) {
...
:deep(.custom-blue-input .el-input__inner) {
  text-align: center !important;
  font-weight: 700 !important;
  font-size: 1.125rem !important;
  color: #1e3a8a !important;
}
:deep(.custom-blue-input .el-input__wrapper.is-focus) {
  border-color: #3b82f6 !important;
  box-shadow: 0 0 0 4px rgba(219, 234, 254, 0.5) !important;
}
