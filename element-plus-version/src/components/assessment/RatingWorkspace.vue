    ...
    <div class="flex-1 p-4 grid grid-cols-12 gap-6 items-start">
          ...
          <div class="flex-1 overflow-y-auto p-3 space-y-1 custom-scrollbar">
            ...
            >
              <div class="flex items-center gap-3 min-w-0">
                <el-avatar
                  :size="40"
                  class="border-2 border-white shadow-sm shrink-0"
                  :class="[selectedEmpId === emp.id ? '!bg-indigo-100 !text-indigo-700 font-bold' : '!bg-slate-100 !text-slate-500 font-medium']"
                >
                   {{ emp.avatar }}
                </el-avatar>
                <div class="min-w-0">
      ...
      <div class="col-span-9 bg-white rounded-[32px] border border-slate-200 shadow-sm flex flex-col">
        <template v-if="selectedEmp">
          ...
          <div class="px-8 py-3 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between shrink-0">
            <div class="flex items-center gap-5">
              <div class="relative">
                <el-avatar
                  :size="64"
                  class="border-4 border-white shadow-md !bg-indigo-100 !text-indigo-700 !text-xl !font-black"
                >
                   {{ selectedEmp.avatar }}
                </el-avatar>
              ...
              <div>
                <div class="flex items-center gap-3 mb-1">
                   ...
                   <el-tag type="info" effect="plain" class="!bg-white !border-slate-200 !text-slate-500 !font-bold px-3">
            ...
            <div class="flex items-center gap-3">
              ...
              <el-button round class="!h-10 border-slate-200 !text-slate-600 !bg-white !text-sm !font-bold" :disabled="props.isLocked">
                 <History class="h-4 w-4 mr-2" />
                 查看历史评价
              </el-button>
              <el-button type="primary" round class="!h-10 !bg-indigo-600 hover:!bg-indigo-700 !text-white shadow-md shadow-indigo-100 text-sm font-bold" :disabled="props.isLocked">
          ...
          <div class="flex-1 px-8 py-4 space-y-6 bg-slate-50/20">
            <div v-if="props.isLocked" class="mb-4">
              <div class="bg-amber-50 border border-amber-200 text-amber-800 p-3 rounded-2xl flex items-center gap-3 text-sm">
                 ...
                 <p class="font-medium">当前不处于考评阶段，系统已处于只读浏览模式。</p>
              </div>
            </div>
            <!-- Indicator List -->
            <div class="grid gap-6">
              <el-card 
                ...
                :key="ind.id"
                shadow="never"
                class="custom-el-card !bg-white !border-slate-200 overflow-hidden hover:!border-indigo-200 hover:shadow-sm transition-all duration-300"
                  ...
                  <div class="flex flex-col md:flex-row gap-5 items-start">
                    ...
                    <div class="flex-1 space-y-3 w-full">
                       <div class="flex items-center gap-3">
                          ...
                          <el-tag type="info" effect="plain" class="!bg-indigo-50 !text-indigo-600 !font-bold !border-none">{{ ind.nature }}</el-tag>
                       </div>
                          ...
                          <div class="bg-indigo-50/50 rounded-2xl border border-indigo-100 p-4 shadow-inner">
                            ...
                            <div class="flex items-center gap-3">
                               <el-input 
                                  ...
                                  v-model.number="qualitativeScores[ind.id]"
          ...
          <!-- Bottom Footer Logic -->
          <div class="px-8 py-5 border-t border-slate-100 bg-white shrink-0 flex items-center justify-end rounded-b-[32px]">
             <div class="flex items-center gap-4">
                <el-button text class="!text-slate-500 !font-bold hover:!bg-slate-50" @click="selectedEmpId = ''">取消打分项</el-button>
                <el-button type="primary" round class="!bg-indigo-600 hover:!bg-indigo-700 !text-white !font-black !px-12 !h-12 !rounded-xl shadow-lg shadow-indigo-100 group transition-all" :disabled="props.isLocked">
                   确认并封存本条打分项
...
:deep(.custom-score-input .el-input__wrapper) {
...
:deep(.custom-score-input .el-input__inner) {
  text-align: center !important;
  font-weight: 900 !important;
  font-size: 1.125rem !important;
  color: #312e81 !important;
}
:deep(.custom-score-input .el-input__wrapper.is-focus) {
  border-color: #818cf8 !important;
