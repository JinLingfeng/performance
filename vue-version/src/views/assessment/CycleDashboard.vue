  ...
  <div class="max-w-7xl mx-auto px-4 xl:px-8 pb-20 space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div class="flex items-center gap-4">
        <Button variant="outline" size="icon" @click="goBack" class="rounded-full shadow-sm bg-white shrink-0">
          <ChevronLeft class="h-4 w-4" />
        </Button>
        <div>
          <div class="flex items-center gap-2 mb-1">
             <Badge variant="secondary" class="bg-blue-100 text-blue-700">绩效大盘</Badge>
      ...
      <div class="flex items-center gap-2 shrink-0">
        <Button variant="outline" size="sm" class="bg-white border-slate-200 text-slate-600">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <Card class="shadow-sm border-slate-200 overflow-hidden relative group transition-all hover:shadow-md">
    ...
    <div class="space-y-4">
      <Card v-for="dept in departments" :key="dept.id" class="shadow-sm border-slate-200 overflow-hidden transition-all duration-300">
        <div 
          ...
          <div class="flex items-center gap-4 min-w-0">
             ...
             <div class="min-w-0">
                <div class="flex items-center gap-2">
                   ...
                   <Badge variant="secondary" class="bg-slate-100 text-slate-500 font-bold border-none text-[10px]">{{ dept.headcount }}人</Badge>
                </div>
                <div class="flex items-center gap-2 mt-2">
                   <span class="text-[10px] text-slate-400 font-bold uppercase">评分进度</span>
                   <Progress :model-value="(dept.ratedCount / dept.headcount) * 100" class="w-16 h-1.5" />
                    ...
                    <div class="flex items-center justify-end">
                      <TooltipProvider>
                        <Tooltip :delay-duration="100">
                          ...
                          <TooltipContent side="left" class="p-0 border-none shadow-2xl overflow-hidden rounded-xl">
...
/* Standard subtle animation for entry */
.animate-in {
...
/* Make Progress background more sophisticated */
:deep(.progress-root) {
  @apply bg-slate-100 rounded-full overflow-hidden;
}
:deep(.progress-indicator) {
  @apply bg-blue-500 rounded-full transition-all duration-700 ease-in-out;
}
</style>
