...
<template>
  <div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h2 class="text-xl font-bold tracking-tight text-slate-900 border-l-4 border-blue-600 pl-3">企业指标元数据库</h2>
        <p class="text-xs text-slate-500 mt-1 pl-4">管理维护全公司所有业务及职能部门的考核考分元数据标准。</p>
      </div>
      <div class="flex flex-wrap items-center gap-3">
        ...
        <Select v-model="dimensionFilter">
          <SelectTrigger class="w-[120px] bg-white h-9 text-sm">
        ...
        <Button @click="handleAddNew" size="sm" class="shrink-0">
